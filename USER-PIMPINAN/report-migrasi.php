...
<body id="page-top">
    <center>
        ...
        <h3 style="color:black;">Report / Laporan Migrasi</h3>
        <hr width="200px"><br>
        <div class="col-lg-12">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="color:black;">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center" width="80px">Migrasi</th>
                    ...
                    include "../config.php";
                    $no = 1;
                    $q = mysqli_query($con, "SELECT * FROM migrasi WHERE status = 'FINISHED'");
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align: center"><?= $d['daya_sebelum'] ?> >> <?= $d['daya_migrasi'] ?></td>
